      ...
      <div className="wrapper">
        ...
        <div className="information">
          ...
          <h3>Contact us using the information below! <br /> Please fill out the form to the right :) </h3>
            <info className="fa fa-map-marker" /><span className="details"> Loyola University Chicago </span><br />
            <info className="fa fa-phone fa-lg" /><span className="details"> 1234567890 </span><br />
